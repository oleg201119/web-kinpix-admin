                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <button id="send" class="btn btn-info btn-w-m" onclick="send()" type="button" <?php if ($this->session->userdata('login_permission') == 0) echo "disabled"; ?>>Send Email</button>
...
<script type="text/javascript">
    ...
    function send() {
        $.ajax({
            async: true,
            url: "<?php echo site_url('admin/send_content') ?>",
            dataType: "json",
            type: "POST",
            data: {
                screen: 'terms'
